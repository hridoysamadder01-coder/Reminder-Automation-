...
/*
 * ── বাংলা ব্যাখ্যা ──────────────────────────────────────────────
 * কথার ভেতর থেকে তারিখ-সময় বের করে: আজ/কাল/পরশু, সকাল/দুপুর/বিকাল/সন্ধ্যা/রাত,
 * "10 tay", "১০:৩০", "9 pm", "10 minute por" — সব চেনে।
 * গুরুত্বপূর্ণ নিয়মগুলো:
 *  - সময় অস্পষ্ট হলে (যেমন "kal shokale") অনুমান করে না — NeedsTime ফেরত দেয়,
 *    UI তখন জিজ্ঞেস করে "কয়টায়?"
 *  - "রাত ১২টা/রাত ২টা" মধ্যরাত পার করে পরের দিনে পড়ে।
 *  - স্পষ্ট বলা সময় অতীত হয়ে গেলে (আজ সকাল ৮টা, এখন রাত ৮টা) PastTime —
 *    চুপচাপ কখনো অতীতে রিমাইন্ডার বসে না।
 *  - খালি সংখ্যা (কাল ১০) সময় ধরা হয় না, "টায়/tay/baje" জাতীয় সূত্র লাগে —
 *    নাহলে "৫০০ টাকা"-র ৫০০-ও সময় হয়ে যেত।
 */
